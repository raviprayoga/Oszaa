    ...
    render(){
        return(
            <Container className="detail-katalog">
                <Row>
                    <Col sm="4">
                    <img className="w-100" src="/images/katalog3.jpg" />
                    ...
                    <div className="desc-katalog">
                        ...
                        <h5>Kaos adalah kaos yang menggunakan benang a sehingga tidak mudah rusak</h5>
                        <h3 className="harga">Rp. 95.000</h3>
