    ...
    render(){
        return(
            <Container className="detail-katalog">
                <Row>
                    <Col sm="4">
                    <img className="w-100" src="/images/katalog18.jpg" />
                    ...
                    <div className="desc-katalog">
                        ...
                        <h5>Blouse adalah Blouse yang menggunakan benang a sehingga tidak mudah rusak</h5>
                        <h3 className="harga">Rp. 235.000</h3>
