    ...
    render(){
        return(
            <Container className="detail-katalog">
                <Row>
                    <Col sm="4">
                    <img className="w-100" src="/images/katalog13.jpg" />
                    ...
                    <div className="desc-katalog">
                        ...
                        <h5>Kemeja adalah Kemeja yang menggunakan benang a sehingga tidak mudah rusak</h5>
                        ...
                        <div className="warna">
                            ...
                            <div className="warna-item purpe"> </div>
