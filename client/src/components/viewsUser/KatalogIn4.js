    ...
    render(){
        return(
            <Container className="detail-katalog">
                <Row>
                    <Col sm="4">
                    <img className="w-100" src="/images/katalog4.jpg" />
                    ...
                    <div className="desc-katalog">
                        ...
                        <h5>Jaket adalah jaket yang menggunakan benang a sehingga tidak mudah rusak</h5>
                        <h3 className="harga">Rp. 335.000</h3>
                        <p style={{textAlign:"left"}}>Stok Tersedia: 5</p>
                        <div className="warna">
                            <p>Warna Tersedia: </p>
